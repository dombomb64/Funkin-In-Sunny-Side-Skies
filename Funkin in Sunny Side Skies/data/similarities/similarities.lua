function onCreate()
	...
	--if difficulty == 3 then
		...
		makeLuaSprite('emergencyMeeting1', 'emergencyMeeting1', 0, 0);
		makeAnimatedLuaSprite('emergencyMeeting2', 'emergencyMeeting2', 0, 0);
		makeAnimatedLuaSprite('emergencyMeeting3', 'emergencyMeeting3', 0, 0);
