...
function onCreate()
	...
	precacheImage('appleThrow1');
	precacheImage('appleThrow2');
	precacheImage('appleThrow3');
	precacheImage('appleExplosion1');
	precacheImage('appleExplosion2');
	...
	makeAnimatedLuaSprite('appleThrow1', 'appleThrow1', 0, 0);
	makeAnimatedLuaSprite('appleThrow2', 'appleThrow2', 0, 0);
	makeLuaSprite('appleExplosion1', 'appleExplosion1', 0, 0);
	makeAnimatedLuaSprite('appleExplosion2', 'appleExplosion2', 0, 0);
	makeLuaSprite('appleExplosion3', 'appleExplosion3', 0, 0);
