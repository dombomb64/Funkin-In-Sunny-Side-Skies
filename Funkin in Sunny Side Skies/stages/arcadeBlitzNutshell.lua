function onCreate()
	...
	setProperty('modchartSprites[arcadeBlitzNutshell1].antialiasing', false);
	...
	--setProperty('modchartSprites[arcadeBlitzNutshell2].antialiasing', false);
	...
	setProperty('modchartSprites[arcadeBlitzNutshell3].antialiasing', false);
